...
# %%
function plot_cdfpval(m, n, p, q = p; L = 10^6,
        pvalfunc1 = pvalue_or_fisher_sterne,
        pvalfunc2 = pvalue_or_fisher_cp,
        name1 = "OR Fisher (Sterne)",
        name2 = "OR Fisher (CP)",
    )
    bin1 = Binomial(m, p)
    bin2 = Binomial(n, q)
    ...
    Threads.@threads for i in 1:L
        ...
        b, d = m-a, n-c
        pval1[i] = pvalfunc1(a, b, c, d)
        pval2[i] = pvalfunc2(a, b, c, d)
    end
    ecdf1 = ecdf(pval1)
    ecdf2 = ecdf(pval2)
    f1(x) = ecdf1(x)
    ...
    plot!(plot_title="Assumption: data is generated by Bin($m, $p)×Bin($n, $q)")
end

# %%
plot_cdfpval(5, 8, 0.2;
    pvalfunc1 = pvalue_or_fisher_sterne,
    pvalfunc2 = pvalue_or_fisher_cp,
    name1 = "OR Fisher (Sterne)",
    name2 = "OR Fisher (CP)",
...
# %%
plot_cdfpval(5, 8, 0.2;
    pvalfunc1 = pvalue_or_pearson_chisq,
    pvalfunc2 = pvalue_or_wald,
    name1 = "OR Pearson χ²",
    name2 = "OR Wald",
)
...
# %%
plot_cdfpval(5, 8, 0.2;
    pvalfunc1 = pvalue_rr_pearson_chisq,
    pvalfunc2 = pvalue_rr_wald,
    name1 = "RR Pearson χ²",
    name2 = "RR Wald",
)

# %%
plot_cdfpval(10, 16, 0.2;
    pvalfunc1 = pvalue_or_fisher_sterne,
    pvalfunc2 = pvalue_or_fisher_cp,
    name1 = "OR Fisher (Sterne)",
    name2 = "OR Fisher (CP)",
