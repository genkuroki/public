...
@show pvalue_or_bayes_cp(a, b, c, d; prior)
...
@show pvalue_rd_bayes_cp(a, b, c, d; prior)
...
plot(Δ -> pvalue_rd_bayes_cp(a, b, c, d; Δ, prior), -0.02, 0.24; label="RD Bayesian")
...
@show pvalue_rr_bayes_cp(a, b, c, d; prior)
