...
* 現在、知覚は、肯定的な報告に関するインセンティブを見るように操作される一方で、否定的な報告に関するインセンティブは無視されている…
...
<b>訳註:</b> rBSTは遺伝子組換えウシ成長ホルモンのこと。rbSTの投与の有無についての「<span style="color:red;font-weight:bold">有意差は得られていない</span>」という但し書きの強制によって特定の利益団体が利益を得た
...
* <span style="color:red;font-weight:bold">集団思考と群集行動バイアス(反復バイアスなど) (groupthink and herd-behavior biases such as repetition bias)</span>: エコーチャンバー効果、集団内での相互強化によって証拠が沢山あるかのように見えてしまうこと。
</span>

<b>訳註:</b> 
* 「ストリクトリー・ボールルーム」(“Strictly Ballroom”)は1992年制作のオーストラリア映画(邦題『ダンシング・ヒーロー』、[ダンシング・ヒーロー (映画) - Wikipedia](https://ja.wikipedia.org/wiki/%E3%83%80%E3%83%B3%E3%82%B7%E3%83%B3%E3%82%B0%E3%83%BB%E3%83%92%E3%83%BC%E3%83%AD%E3%83%BC_(%E6%98%A0%E7%94%BB)))。オーストラリアの競技ダンス界を舞台に、型にはまったダンスのルールや慣習に反発し、自分のスタイルで踊ろうとする若いダンサーの物語。保守的で伝統に固執するダンス界の「型破り」を描く。
* 「反復バイアス(repetition bias)」は「何度も引用・使用される仮説や結果が、検証の弱さにかかわらず「妥当」だとみなされ易くなる偏り」という意味。
...
<span style="color:red;font-weight:bold">数学的正当化をあたかも十分な実践的正当化であるかのように扱うのを<span style="border-bottom: solid 2px">やめよ</span></span>
...
<span style="color:red;font-weight:bold">価値バイアス(value bias)</span>は統計的方法論に浸透しており、最も頻繁には<span style="color:red;font-weight:bold">ゼロ主義(nullism)</span> (ゼロ仮説を「受容する」ことに偏った価値観)の形で現れる:
...
* 結論: 結果は効果サイズや方向を決定するには不正確すぎ、イベルメクチン群の入院オッズはプラセボ群と比較して68%低いものから31%高いものまで、死亡オッズは70%低いものから500%高いものまでと、最も相性が良かった。
...
* もしすべての因果パスがランダムウォークであれば、実際の効果は帰無仮説の近くに集まるかもしれず、ほとんどの効果サイズは「重要でない」ものになるだろう… しかし、
