...
<img width=100% src="https://github.com/genkuroki/public/raw/main/0055/GreenlandSlide2022JapaneseTranslation/Rafi--Greenland_2020a.jpg">
...
<img width=100% src="https://github.com/genkuroki/public/raw/main/0055/GreenlandSlide2022JapaneseTranslation/Rafi--Greenland_1909.08579.jpg">
...
<img width=100% src="https://github.com/genkuroki/public/raw/main/0055/GreenlandSlide2022JapaneseTranslation/Refi--Greenland_2020b.jpg">
...
「ソフト」サイエンスでは、「効果なし」仮説と、その周囲の重要な効果を含む区間に含まれる代替仮説を区別することはほとんどできない。
...
因果的な節約性が、観察された(ノンパラメトリックな)データ分布と整合する最も単純な因果図式を好むと定義されると仮定する。すると、

* 報告された効果を、その関連を生み出すより複雑なメカニズムのシステムに訴えることなく退ける根拠はない。必要な因果図式は、より多くの矢線とより大きな効果を必要とする。

</span>

因果パーシモニーを、観測された（非パラメトリック）データ分布と両立する最も単純な因果図式を好むことと定義すると、

報告された効果を却下する根拠は存在しない。なぜならその関連を生み出すより複雑なメカニズムの体系に頼らない限り説明できないからである。必要な因果図式は、より多くの矢線とより大きな効果を必要とする。
...
帰無仮説(a-d)を主張することは、因果関係(e)に比べて、余分な変数(ノード)または効果(矢線)を必要とする。
...
* それらの代替的な説明は、複雑性を説明の因果図式(cDAG)に必要な最小の変数と矢線の数として定義するならば、直接的な因果的説明(因果的帰無仮説の棄却)よりも常に複雑である。
