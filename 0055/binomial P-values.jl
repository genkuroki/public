...
#
# と定義されます。この確率の値(片側P値の値)は0.36%とかなり小さくなります(計算の仕方の詳細は後述)。だから、
#
...
# %% [markdown]
# 両側P値は (片側P値) $= 0.003611472059128871$ の2倍なので、
#
