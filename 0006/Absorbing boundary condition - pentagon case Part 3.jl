...
# %%
anim_sol2D(sol; fn="wave eq on pentagon with dirichlet bc 2d Part 3.gif", clim=(-0.15, 0.15))

# %%
plot_sol(sol, 1.0; zlim=(-0.15, 0.15))

# %%
anim_sol(sol; fn="wave eq on pentagon with dirichlet bc Part 3.gif", zlim=(-0.15, 0.15))
...
# %%
anim_sol2D(sol; fn="wave eq on pentagon with neumann 2d bc Part 3.gif", clim=(-0.15, 0.15))

# %%
plot_sol(sol, 1.0; zlim=(-0.15, 0.15))

# %%
anim_sol(sol; fn="wave eq on pentagon with neumann bc Part 3.gif", zlim=(-0.15, 0.15))
...
# %%
anim_sol2D(sol; L=301, fn="wave eq on pentagon with absorbing bc 2d Part 3.gif", clim=(-0.15, 0.15))

# %%
plot_sol(sol, 2.0; zlim=(-0.15, 0.15))

# %%
anim_sol(sol; L=151, fn="wave eq on pentagon with absorbing bc Part 3.gif", zlim=(-0.15, 0.15))
