...
# %%
anim_sol(sol; fn="wave eq on pentagon with dirichlet bc Part 2.gif", zlim=(-0.15, 0.15))
...
# %%
anim_sol(sol; fn="wave eq on pentagon with neumann bc Part 2.gif", zlim=(-0.15, 0.15))
...
# %%
anim_sol(sol; L=151, fn="wave eq on pentagon with absorbing bc Part 2.gif", zlim=(-0.15, 0.15))
