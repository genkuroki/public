...
# %%
anim_sol2D(sol; fn="wave eq on pentagon with dirichlet bc 2d.gif")

# %%
plot_sol(sol, 1.0)

# %%
anim_sol(sol; fn="wave eq on pentagon with dirichlet bc.gif")
...
# %%
anim_sol2D(sol; fn="wave eq on pentagon with neumann bc 2d.gif")

# %%
plot_sol(sol, 1.0)

# %%
anim_sol(sol; fn="wave eq on pentagon with neumann bc.gif")
...
# %%
anim_sol2D(sol; fn="wave eq on pentagon with absorbing bc 2d.gif")

# %%
plot_sol(sol, 1.0)

# %%
anim_sol(sol; fn="wave eq on pentagon with absorbing bc.gif")
