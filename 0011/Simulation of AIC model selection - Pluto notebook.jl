...
# ╔═╡ d1785060-e3de-11eb-01ce-276ee2d9126b
using Distributions, StatsPlots

# ╔═╡ ec69fada-0edd-4f58-afdf-69ddebf6dbfe
VERSION

# ╔═╡ fd1d7904-1791-4e9c-a3df-d8b9b715f163
function aic(model, Y)
    mle = fit_mle(model, Y)
    -2loglikelihood(mle, Y) + 2length(params(mle))
end

# ╔═╡ 4a8b54c8-a6fb-4781-aa79-3843c6d28b87
...
# ╔═╡ dcfc5460-bcfb-46cb-958c-434c9d054f33
begin
	a, b = 0, 40
...
# ╔═╡ 1ab5ba32-af07-4e50-8ab0-cbf23d2b5495
models = (Gamma, Weibull, LogNormal)

# ╔═╡ 9b2848a4-7542-498c-9941-b085ac67b80c
Threads.nthreads()

# ╔═╡ dee3f8fb-aa09-4893-95f9-023f2ba60aa1
simulate_model_selections(models, Gamma(5, 2), 100; niters = 10^4)

# ╔═╡ 28dea529-8bb2-45b3-98a6-b71f8f75d904
simulate_model_selections(models, Weibull(2.4, 11.3), 100; niters = 10^4)

# ╔═╡ aa9dddd0-e847-4508-8c37-9f05950c5d95
