...
# ╔═╡ d290692f-9a9a-438a-bcdb-1fe689010a40
begin
	using Plots
	using StaticArrays
	using Parameters
...
# ╔═╡ a2a60616-1f5e-4483-b943-0b7395137b83
default(colorbar=false)

# ╔═╡ 727f71b2-c61c-4999-93a5-c7555b008c71
...
# ╔═╡ 3714ec52-00ed-11ec-32d6-2901d198eb0c
...
# ╔═╡ 68e787a0-fcda-470c-97d3-70f52480b26f
...
# ╔═╡ 149195b5-57d5-4289-9fb4-05902c32923f
begin
	torusparam = (a = 5, b = 10, d = SVector(1, 0, 1))
	n_torus = 50
	u_torus = v_torus = range(0, 2π; length = n_torus + 1)
end;

# ╔═╡ 7c8a1a8a-b306-4a36-9136-4377c4e64318
begin
	pyplot(fmt=:png)
...
# ╔═╡ b70943b5-f5fd-4e15-972a-cbfbb2f4d6d6
begin
	pyplot(fmt=:png)
	@time anim_torus = @animate for t in range(0, 360; length=41)[1:end-1]
		plot_surface(u_torus, v_torus, torusfunc, torusparam; size=(400, 300),
			lims=(-20, 20), color=:CMRmap, R=rotate(30, 30, 30),
			camera=(t, 20), ticks=false)
	end
	PyPlot.clf()
	gif(anim_torus, "torus.gif")
end

# ╔═╡ c946cd89-e638-41a4-b67c-d29effd6ee67
...
# ╔═╡ 40143b9f-d315-4d64-9e61-cb0c3b4fdd00
begin
	sphereparam = (
		r = 20,
		d = SVector(0, 0, 1),
	...
	n_sphere = 50
	u_sphere = range(-π/2, π/2; length = n_sphere + 1)
	v_sphere = range(0, 2π; length = 2n_sphere + 1)
end;

# ╔═╡ c262a2f7-bb17-464a-ae18-de01b90a31de
begin
	pyplot(fmt=:png)
...
# ╔═╡ 13588c58-4c46-4e66-b4c6-286d391638de
begin
	pyplot(fmt=:png)
	@time anim_sphere = @animate for t in range(0, 360; length=41)[1:end-1]
		plot_surface(u_sphere, v_sphere, spherefunc, sphereparam; size=(400, 300),
			lims=(-20, 20), color=:gist_earth, R=rotate(30, 30, 30),
			camera=(t, 20), ticks=false)
	end
	PyPlot.clf()
	gif(anim_sphere, "sphere.gif")
end

# ╔═╡ abb2dd2c-b9a3-4360-a7ac-9c1c150d84f2
begin
	plotly(fmt=:auto)
...
# ╔═╡ 18543853-b564-43ab-875d-a945b0f0c39e
begin
	plotly(fmt=:auto)
...
# ╔═╡ ab855ed4-cc27-4f36-93de-2875e3fac9fe
...
git-tree-sha1 = "ad5dc3a3bc18246d552aad6c78268102becd9d59"
uuid = "58dd65bb-95f3-509e-9936-c39a10fdeae7"
version = "0.4.0"

[[PlotlyBase]]
deps = ["Base64", "Dates", "DelimitedFiles", "DocStringExtensions", "JSON", "Kaleido_jll", "LaTeXStrings", "Logging", "Pkg", "REPL", "Requires", "Statistics", "UUIDs"]
git-tree-sha1 = "bca220daa9705b891a42c6ce0c20534a3196e73e"
uuid = "a03496cd-edff-5a9b-9e67-9cda94a718b5"
version = "0.5.4"

[[PlotlyJS]]
deps = ["Blink", "DelimitedFiles", "JSExpr", "JSON", "Markdown", "Pkg", "PlotlyBase", "REPL", "Reexport", "Requires", "WebIO"]
git-tree-sha1 = "b859551864853bb2c317d0937e94bd19d749396b"
